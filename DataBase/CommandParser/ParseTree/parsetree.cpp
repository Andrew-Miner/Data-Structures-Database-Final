...
bool PTree::InsertInOrder(const std::string& identifier, const std::string& item)
{
    sub_node<std::string>* sub = getSubTree(identifier);
    ...
    return _insert_right(sub, item);
}


bool PTree::InsertLeft(const std::string& identifier, const std::string& item)
{
    sub_node<std::string>* sub = getSubTree(identifier);
    ...
    return _insert_left(sub, item);
}

bool PTree::InsertRight(const std::string& identifier, const std::string& item)
{
    return InsertInOrder(identifier, item);
}
