...
template <typename T>
sub_node<T>* _insert_right(sub_node<T>* &root, const T &item);

template <typename T>
sub_node<T>* _insert_left(sub_node<T>* &root, const T &item);
...
{
    sub_node<T>* newNode = new sub_node<T>(id);
...
sub_node<T>* _insert(sub_node<T>* &root, const T &item)
{
    ...
    if(item < root->item)
        return _insert(root->left, item);
    else
        return _insert(root->right, item);
}
...
sub_node<T>* _insert_right(sub_node<T>* &root, const T &item)
{
    if(!root)
        ...
        return _insert_right(root->right, item);
}
...
sub_node<T>* _insert_left(sub_node<T>* &root, const T &item)
{
    if(!root)
        ...
        return _insert_left(root->left, item);
}
