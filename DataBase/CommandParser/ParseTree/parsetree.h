...
public:
   ...
   ~PTree();
    ...
    bool InsertInOrder(const std::string& identifier, const std::string& item);

    bool InsertLeft(const std::string& identifier, const std::string& item);
    bool InsertRight(const std::string& identifier, const std::string& item);
